...
section  .data
    ...
    mensajeFin              db  10, 10, '¡Haz decidio finalizar el juego en este estado! Es una pena.... Por suerte tu partida ha sido guardada automaticamente. Cuando vuelvas a ingresar al juego puedes continuar..', 10, 10, 0; %i 32 bits / %li 64 bits
